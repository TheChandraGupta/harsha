...
<script type="text/javascript" src="pages/js/validation.min.js"></script>
    <script type="text/javascript" src="pages/js/interventiontype.js"></script>
        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Intervention Type Information</h3>
                  <!-- MODAL BUTTON -->
                  
                   <button class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-toggle="tooltip" title="Add New Intervention Type" data-target="#myModal"> <span class="glyphicon glyphicon-plus"></span></button>
	...
	<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><b>Add New Intervention Type</b></h4>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="afterinsertingheading">
							<div class="form-group">
								<form method="post" id="projecttype-form" >
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="projectTypeName" id="projectTypeName" placeholder="Intervention Type Name">
								</div>
							...
							<div class="form-group">
								...
								<br>
									<button type="submit" class="btn btn-primary pull-right" name="btn-projecttype" id="btn-projecttype">Add</button>
								</div>
							</div>
						</form>
					</div>
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <%
						int i =0;
						while(i<allProjectType.size()) {
							ProjectTypeBean project = allProjectType.get(i);
							i++;
						%>
						<tr>
							<td ><%=project.getProjectTypeName() %></td>
							<td> 
								<input type="hidden" id="<%=i %>" value="<%=project.getProjectTypeId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminInterventionTypeInfo.jsp?projectTypeId="+document.getElementById(ur).value,"", "width=600, height=300");
