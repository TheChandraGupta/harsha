	 ...
	 $("#project-updateform").validate({
      rules:
	  {
	   ...
	   {		
			...
			$.ajax({
			type: "POST",
			url: 'pages/admin/updateInterventionType.jsp',
			data: data,
			cache: false,
			beforeSend: function()
			{	
			...
			success :  function(response){	
				...
				if(s=="ok"){					
					...
					$("#project-updateform").html('<div class="callout callout-info lead"><h4>Updated Intervention Type successfully..!</h4></div>');
