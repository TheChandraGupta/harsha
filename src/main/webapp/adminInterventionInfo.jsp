...
ProjectBean allProject = DBHandler.getByProjectId( projectId,dbManager);
...
<!-- Site wrapper -->
            ...
            <div class="box-body">
				  ...
				  <form method="post" id="project-updateform" >
								...
								<div class="col-sm-8">
									<input type="hidden" name="projectId" id="projectId" value=<%=allProject.getProjectId()%>>
					 	
									<input type="text" class="form-control" name="projectName" id="projectName" value="<%=allProject.getProjectName() %>">
								</div>
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="donerName" id="donerName" value="<%=allProject.getDonerName() %>">
								</div>
