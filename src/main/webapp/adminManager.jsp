      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			<div class="box">
                     ...
                     <%
						int i =0;
	                 	while(i<manager.size()) {
							UserViewBean managerUser = manager.get(i);
						...
						<tr>
							...
							<td ><%=managerUser.getLastActivity() %></td>
							<input type="hidden" id="<%=i %>" value="<%=managerUser.getUserId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminManagerInfo.jsp?userId="+document.getElementById(ur).value,"", "width=1000, height=500");
