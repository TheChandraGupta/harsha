...
<script type="text/javascript" src="pages/js/validation.min.js"></script>
    <script type="text/javascript" src="pages/js/education.js"></script>
        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Education Information</h3>
                  <!-- MODAL BUTTON -->
                  
                   <button class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-toggle="tooltip" title="Add New Education" data-target="#myModal"> <span class="glyphicon glyphicon-plus"></span></button>
	...
	<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><b>Add New Education</b></h4>
				</div>
				...
				<div class="modal-body">
					<div class="panel-body" id="afterinsertingheading">
							<div class="form-group">
								...
								<label for="heading" class="col-sm-3 control-label">Education Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="educationName" id="educationName" placeholder="Education Name">
								</div>
							
								<br><br><br>
							
							
								<label for="heading" class="col-sm-3 control-label">Education code</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="educationCode" id="educationCode" placeholder="Education Code">
								</div>
							...
							<div class="form-group">
								...
								<br>
									<button type="submit" class="btn btn-primary pull-right" name="btn-education" id="btn-education">Add</button>
								</div>
							</div>
						</form>
					</div>
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
					<tr>
                      <th align="center">Education Name</th>
					  <th align="center">Education Code</th>
                   ...
                   <%
						...
						while(i<education.size()) {
							EducationBean educations = education.get(i);
							counter++;
						%>
						<tr>
							<td ><%=educations.getEducationName() %></td>
							<td ><%=educations.getEducationCode() %></td>
							<td> 
								<input type="hidden" id="<%=i %>" value="<%=educations.getEducationId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminEducationInfo.jsp?educationId="+document.getElementById(ur).value,"", "width=300, height=300");
