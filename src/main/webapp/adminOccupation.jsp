...
<script type="text/javascript" src="pages/js/validation.min.js"></script>
    <script type="text/javascript" src="pages/js/occupation.js"></script>
        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Occupation Information</h3>
                  <!-- MODAL BUTTON -->
                  
                   <button class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-toggle="tooltip" title="Add New Occupation" data-target="#myModal"> <span class="glyphicon glyphicon-plus"></span></button>
	...
	<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><b>Add New occupation</b></h4>
				</div>
				...
				<div class="modal-body">
					<div class="panel-body" id="afterinsertingheading">
							<div class="form-group">
								...
								<label for="heading" class="col-sm-3 control-label">Occupation Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="occupationName" id="occupationName" placeholder="Occupation Name">
								</div>
							
								<br><br><br>
							
							
								<label for="heading" class="col-sm-3 control-label">Occupation code</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="occupationCode" id="occupationCode" placeholder="Occupation Code">
								</div>
							...
							<div class="form-group">
								...
								<br>
									<button type="submit" class="btn btn-primary pull-right" name="btn-occupation" id="btn-occupation">Add</button>
								</div>
							</div>
						</form>
					</div>
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<tr>
					  ...
					  <th align="center">Occupation Code</th>
                    ...
                    <tbody>
                   		<%
						int i =0;
						while(i<occupation.size()) {
							OccupationBean occupations = occupation.get(i);
							counter++;
						%>
						<tr>
							
							<td ><%=occupations.getOccupationName() %></td>
							<td ><%=occupations.getOccupationCode() %></td>
							<td> 
								<input type="hidden" id="<%=i %>" value="<%=occupations.getOccupationId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminOccupationInfo.jsp?occupationId="+document.getElementById(ur).value,"", "width=300, height=300");
