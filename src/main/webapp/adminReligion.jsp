...
<script type="text/javascript" src="pages/js/validation.min.js"></script>
    <script type="text/javascript" src="pages/js/religion.js"></script>
        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Religion Information</h3>
                  <!-- MODAL BUTTON -->
	...
	<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><b>Add New Religion</b></h4>
				</div>

				<div class="modal-body">
					<div class="panel-body" id="afterinsertingheading">
							<div class="form-group">
								<form method="post" id="religion-form">
								<div class="col-sm-offset-3 col-sm-8">
										<span class='msg' id="error"></span>
								</div>
								<label for="heading" class="col-sm-3 control-label">Religion Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="religionName" id="religionName" placeholder="Religion Name">
								</div>
							
								<br><br><br>
							
							
								<label for="heading" class="col-sm-3 control-label">Religion code</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="religionCode" id="religionCode" placeholder="Religion Code">
								</div>
							...
							<div class="form-group">
								...
								<br>
									<button type="submit" class="btn btn-primary pull-right" name="btn-religion" id="btn-religion">Add</button>
								</div>
							</div>
						</form>
					</div>
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<tr>
					  ...
					  <th align="center">Religion Code</th>
                    ...
                    <%
						...
						while(i<religion.size()) {
							ReligionBean religions = religion.get(i);
							counter++;
						%>
						<tr>
							<td ><%=religions.getReligionName() %></td>
							<td ><%=religions.getReligionCode() %></td>
							<td> 
								<input type="hidden" id="<%=i %>" value="<%=religions.getReligionId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminReligionInfo.jsp?religionId="+document.getElementById(ur).value,"", "width=300, height=300");
