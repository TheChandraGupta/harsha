...
<meta charset="utf-8">
  ...
  <script language="JavaScript">
	...
	{
	status=!status;	
		document.form.username.disabled = status;
		document.form.firstname.disabled = status;
		document.form.lastname.disabled = status;
		document.form.email.disabled = status;
		document.form.address.disabled = status;
		document.form.phonenumber.disabled = status;
		document.form.rolename.disabled = status;
		document.form.password.disabled = status;
		document.form.statusCode.disabled = status;
	}
...
UserViewBean manager = DBHandler.getManager(userId, dbManager);
...
<!-- Site wrapper -->
            ...
            <div class="box-body">
				  ...
				  <form method="post" id="project-updateform" name="form">
								<div class="col-sm-offset-3 col-sm-8">
										<span class='msg' id="error"></span>
								</div>
								<div class="col-sm-offset-3 col-sm-8">
										<p><input type="checkbox" name=others onclick="enable_text(this.checked)" >Edit</p>
								</div>							
								<label for="heading" class="col-sm-3 control-label">User Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="username" name="userName" value=" <%=manager.getUserName()%>" disabled>
                  				</div>
								...
								<div class="col-sm-8">
								  <input type="text" class="form-control" value="<%=manager.getFirstName()%>" id="firstname" name="firstName" disabled >
                  				</div>
								<br><br>
								
								<label for="heading" class="col-sm-3 control-label">Last Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" value=" <%=manager.getLastName()%>" id="lastname" name="lastName" disabled>
                   				</div>
								...
								<div class="col-sm-8">
								<input class="form-control" value=" <%=manager.getEmail()%>" id="email" name="email" type="text" disabled>
                   				</div>
                   				<br><br>
                   				
                   				<label for="heading" class="col-sm-3 control-label">Phone :</label>
								<div class="col-sm-8">
								<input class="form-control" value=" <%=manager.getPhone()%>" id="phonenumber" name="phone" type="text" disabled>
                   				</div>
                   				<br><br>
                   				
                   				<label for="heading" class="col-sm-3 control-label">Address :</label>
								<div class="col-sm-8">
								<input class="form-control" value=" <%=manager.getAddress()%>" id="address" name="address" type="text" disabled>
                   				</div>
                   				<br><br>
                   				
								<label for="heading" class="col-sm-3 control-label">Role Name :</label>
								<div class="col-sm-8">
								 <input class="form-control" value=" <%=manager.getRole() %>" id="rolename" name="rolename" type="text" disabled >
								...
								<div class="col-sm-8">
								<input class="form-control" value=" <%=manager.getStatusCode() %>" id="statusCode" name="statusCode" type="text" disabled>
                   				</div>
                   				<br><br>
