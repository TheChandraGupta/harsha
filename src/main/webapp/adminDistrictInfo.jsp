...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css">
    ...
    <script type="text/javascript" src="pages/js/updatedistrict.js"></script>
...
DistrictBean districtBean=DBHandler.getByDistrictId(districtId, dbManager);
...
<!-- Site wrapper -->
            ...
            <div class="jumbotron">
            <div class="box-body">
               <form method="post" id="district-updateform" >
					<div class="col-sm-offset-3 col-sm-8">
					 ...
					 <label for="heading" class="col-sm-3 control-label">State Name</label>
					   <div class="col-sm-8">
           					  <input type="hidden" name="stateId" id="stateId" value="<%=districtBean.getStateId()%>">  
           			
							<input type="text" class="form-control" name="stateName" id="stateName" value="<%=districtBean.getStateName()%>" >
					  ...
					  <label for="heading" class="col-sm-3 control-label">District Name</label>
					       <div class="col-sm-8">
					       <input type="text" class="form-control" name="districtName" id="districtName" value="<%=districtBean.getDistrictName()%>" >
					 </div>
					 ...
					 <label for="heading" class="col-sm-3 control-label">District Code</label>
					     <div class="col-sm-8">
						<input type="text" class="form-control" id="districtCode" name="districtCode" value="<%=districtBean.getDistrictCode() %>" >
					  </div>
					  <br><br><br>
					  <input type="hidden" name="districtId" value=<%=districtBean.getDistrictId()%>>
