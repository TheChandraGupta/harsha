        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Intervention Information</h3>
                  <!-- MODAL BUTTON -->
                  
                   <button class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-toggle="tooltip" title="Add New Intervention" data-target="#myModal"> <span class="glyphicon glyphicon-plus"></span></button>
	...
	<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><b>Add New Intervention</b></h4>
				</div>
				...
				<div class="modal-body">
					<div class="panel-body" id="afterinsertingheading">
							<div class="form-group">
								...
								<label for="heading" class="col-sm-3 control-label">Intervention Type </label>
            								<div class="col-sm-8">
           									...
           									<br><br><br>
								<label for="heading" class="col-sm-3 control-label">Intervention Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="projectName" id="projectName" placeholder="Intervention Name">
								</div>
							
								<br><br><br>
							
							
								<label for="heading" class="col-sm-3 control-label">Donor Name</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="donerName" id="donerName" placeholder="Donor Name">
								</div>
							...
							<div class="form-group">
								...
								<br>
									<button type="submit" class="btn btn-primary pull-right" name="btn-project" id="btn-project">Add</button>
								</div>
							</div>
						</form>
					</div>
                    ...
                    <tbody>
                     <%
						...
						while(i<allProject.size()) {
							ProjectBean project = allProject.get(i);
							i++;
						%>
						<tr>
							<td ><%=project.getProjectName() %></td>
							<td ><%=project.getDonerName()%></td>
							<td> 
								<input type="hidden" id="<%=i %>" value="<%=project.getProjectId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminInterventionInfo.jsp?projectId="+document.getElementById(ur).value,"", "width=600, height=400");
