...
<meta charset="utf-8">
  ...
  <title>Harsha Trust | ImpactArea Page</title>
       ...
       <div class="box-header">
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped">
					...
					<tr>
					     <th align="center">State Name</td>
					     <td ><%=household.getStateName() %></td>
					 </tr>
					 <tr>
					     <th align="center">State Code</td>
					     <td ><%=household.getStateCode() %></td>
					  </tr>
					  <tr>
					     <th align="center">District Name</td>
					     <td ><%=household.getDistrictname() %></td>
					  </tr>
					  <tr>
					     <th align="center">District Code</td>
					     <td ><%=household.getDistrictCode() %></td>
					  </tr>
					  <tr>
					     <th align="center">Block Name</td>
