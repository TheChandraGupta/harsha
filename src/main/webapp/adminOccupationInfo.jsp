...
<meta charset="utf-8">
  ...
  <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css">
    ...
    <script type="text/javascript" src="pages/js/updateoccupation.js"></script>
...
OccupationBean occupation = DBHandler.getByOccupationId(occupationId, dbManager);
...
<!-- Site wrapper -->  
            ...
            <div class="box-body">
					  ...
					  <form method="post" id="occupation-updateform" >
					...
					<div class="col-sm-8">
									<input type="hidden" name="occupationId" id="occupationId" value=<%=occupation.getOccupationId()%>>
					 	
									<input type="text" class="form-control" name="occupationName" id="occupationName" value="<%=occupation.getOccupationName()%>" >
					</div>
					 <br>
					<label for="heading" class="col-sm-3 control-label">Occupation Code</label>
					<div class="col-sm-8">
							<input type="text" class="form-control" name="occupationCode" id="occupationCode" value="<%=occupation.getOccupationCode()%>" >
					</div>
