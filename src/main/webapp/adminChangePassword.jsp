...
<script type="text/javascript" src="pages/js/validation.min.js"></script>
    <script type="text/javascript" src="pages/js/changepassword.js"></script>
        ...
        <section class="content">
			<div class="box">
                ...
                <div class="box-body table-responsive">
					...
					<label for="heading" class="col-sm-3 control-label">Old Password</label>
					<div class="col-sm-8">
							<input type="password" class="form-control" name="oldpassword" id="oldpassword" placeholder="Enter Old Password">
					</div>
					<br><br><br>
					
					<label for="heading" class="col-sm-3 control-label"> New Password</label>
					<div class="col-sm-8">
							<input type="password" class="form-control" id="newpassword"  name="newpassword" placeholder="Enter Password" >
                    </div>
					<br><br><br>
					<label for="heading" class="col-sm-3 control-label">Retype Password</label>
					<div class="col-sm-8">
					  <input type="password" class="form-control" id="conpassword" name="conpassword" placeholder="Enter Password Again" >
                  </div>
