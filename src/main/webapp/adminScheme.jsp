...
<script type="text/javascript" src="pages/js/validation.min.js"></script>
    <script type="text/javascript" src="pages/js/scheme.js"></script>
			...
			<div class="box">
                <div class="box-header">
                  ...
                  <!-- MODAL BUTTON -->
                   ...
                   <button class="btn btn-primary btn-xs pull-right" data-toggle="modal" data-toggle="tooltip" title="Add New Scheme" data-target="#myModal"> <span class="glyphicon glyphicon-plus"></span></button>
	...
	<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><b>Add New Scheme</b></h4>
				</div>
				...
				<div class="modal-body">
					<div class="panel-body" id="afterinsertingheading">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="schemeName" id="schemeName" placeholder="Scheme Name">
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-8">
								...
								<br>
									<button type="submit" class="btn btn-primary pull-right" name="btn-scheme" id="btn-scheme">Add</button>
								</div>
							</div>
						</form>
					</div>
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
						...
						int i =0;
						while(i<scheme.size()) {
							SchemeBean schemes = scheme.get(i);
							counter++;
						%>
						<tr>
							<td ><%=schemes.getSchemeName() %></td>
							<td> 
								<input type="hidden" id="<%=i %>" value="<%=schemes.getSchemeId() %>"/>
			    ...
			    {
			    	var myWindow = window.open("adminSchemeInfo.jsp?schemeId="+document.getElementById(ur).value,"", "width=300, height=300");
