...
/**
 * Servlet implementation class AddSocialCategory
 */
@WebServlet("/AddSocialCategory")
public class AddSocialCategory extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSocialCategory() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int socialCategoryCode = Integer.parseInt(request.getParameter("socialCategoryCode"));
